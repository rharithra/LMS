...
const Layout = () => {
  ...
  const navigation = [
    ...
    { name: 'New Request', href: '/new-leave-request', icon: PlusIcon },
    ...(user?.role === 'manager' || user?.role === 'admin' ? [
      { name: 'Users', href: '/users', icon: UsersIcon }
    ] : []),
    ...(user?.role === 'admin' ? [
      { name: 'Departments', href: '/departments', icon: BuildingOfficeIcon },
      { name: 'Leave Types', href: '/leave-types', icon: CalendarDaysIcon }
    ] : []),
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:pl-64">
        ...
        {/* Desktop header */}
        <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8 bg-white border-b border-gray-200">
          <div className="flex items-center">
            <h1 className="text-xl font-bold text-gray-900">Leave Management</h1>
          </div>
